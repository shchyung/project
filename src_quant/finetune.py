...
trainloader = DataLoader(
    noisy.NoisyData(
        '../dataset/{}/train/input_all'.format(args.dataset),
        '../dataset/{}/train/target_all'.format(args.dataset),
...
testloader = DataLoader(
    noisy.NoisyData(
        '../dataset/{}/eval/input_all'.format(args.dataset),
        '../dataset/{}/eval/target_all'.format(args.dataset),
        training=False,
    ),
